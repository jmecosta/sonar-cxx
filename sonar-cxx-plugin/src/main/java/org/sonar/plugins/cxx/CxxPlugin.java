...
public final class CxxPlugin extends SonarPlugin {
  ...
  private static List<PropertyDefinition> generalProperties() {
    ...
    List<PropertyDefinition> data = new ArrayList<PropertyDefinition>();
    data.add(PropertyDefinition.builder(SOURCE_FILE_SUFFIXES_KEY)
    ...
    data.add(  PropertyDefinition.builder(HEADER_FILE_SUFFIXES_KEY)
    ...
    data.add(  PropertyDefinition.builder(INCLUDE_DIRECTORIES_KEY)
      ...
      .index(3)
      .build());
      data.add(PropertyDefinition.builder(FORCE_INCLUDE_FILES_KEY)
      .subCategory(subcateg)
      .name("Force includes")
      ...
      .index(4)
      .build());
      data.add(PropertyDefinition.builder(DEFINES_KEY)
      .name("Default macros")
      ...
      .index(5)
      .build());
      data.add(PropertyDefinition.builder(C_FILES_PATTERNS_KEY)
      ...
      .index(6)
      .build());
      data.add(PropertyDefinition.builder(CxxPlugin.ERROR_RECOVERY_KEY)
      .defaultValue("False")
      ...
      .index(7)
      .build());
      data.add(PropertyDefinition.builder(CxxPlugin.MISSING_INCLUDE_WARN)
      .defaultValue("True")
  ...
  private static List<PropertyDefinition> codeAnalysisProperties() {
    ...
    List<PropertyDefinition> data = new ArrayList<>();
    
    data.add(PropertyDefinition.builder(CxxCppCheckSensor.REPORT_PATH_KEY)
      ...
      .index(1)
      .build());
      data.add(PropertyDefinition.builder(CxxCppCheckRuleRepository.CUSTOM_RULES_KEY)
      ...
      .index(2)
      .build());
      data.add(PropertyDefinition.builder(CxxValgrindSensor.REPORT_PATH_KEY)
      ...
      .index(3)
      .build());
      data.add(PropertyDefinition.builder(CxxValgrindRuleRepository.CUSTOM_RULES_KEY)
      ...
      .index(4)
      .build());
      data.add(PropertyDefinition.builder(CxxDrMemorySensor.REPORT_PATH_KEY)
      ...
      .index(5)
      .build());
      data.add(PropertyDefinition.builder(CxxPCLintSensor.REPORT_PATH_KEY)
      ...
      .index(5)
      .build());
      data.add(PropertyDefinition.builder(CxxPCLintRuleRepository.CUSTOM_RULES_KEY)
      ...
      .index(6)
      .build());
      data.add(PropertyDefinition.builder(CxxRatsSensor.REPORT_PATH_KEY)
      .name("RATS report(s)")
      ...
      .index(7)
      .build());
      data.add(PropertyDefinition.builder(CxxRatsRuleRepository.CUSTOM_RULES_KEY)
      ...
      .index(8)
      .build());
      data.add(PropertyDefinition.builder(CxxVeraxxSensor.REPORT_PATH_KEY)
      .name("Vera++ report(s)")
      ...
      .index(9)
      .build());
      data.add(PropertyDefinition.builder(CxxVeraxxRuleRepository.CUSTOM_RULES_KEY)
      ...
      .index(10)
      .build());
      data.add(PropertyDefinition.builder(CxxExternalRulesSensor.REPORT_PATH_KEY)
      ...
      .index(11)
      .build());
      data.add(PropertyDefinition.builder(CxxExternalRuleRepository.RULES_KEY)
      .name("External rules")
      ...
      .index(12)
      .build());
      data.add(PropertyDefinition.builder(CxxExternalRuleRepository.SQALES_KEY)
  ...
  private static List<PropertyDefinition> compilerWarningsProperties() {
    ...
    data.add(
      ...
      .index(1)
      .build());
      data.add(PropertyDefinition.builder(CxxCompilerSensor.PARSER_KEY_DEF)
      ...
      .index(2)
      .build());
      data.add(PropertyDefinition.builder(CxxCompilerSensor.REPORT_CHARSET_DEF)
      ...
      .index(3)
      .build());
      data.add(PropertyDefinition.builder(CxxCompilerSensor.REPORT_REGEX_DEF)
      .name("Custom matcher")
      ...
      .index(4)
      .build());
      data.add(PropertyDefinition.builder(CxxCompilerVcRuleRepository.CUSTOM_RULES_KEY)
      ...
      .index(5)
      .build());
      data.add(PropertyDefinition.builder(CxxCompilerGccRuleRepository.CUSTOM_RULES_KEY)
  ...
  private static List<PropertyDefinition> testingAndCoverageProperties() {
    ...
    data.add(
      ...
      .index(1)
      .build());
      data.add(PropertyDefinition.builder(CxxCoverageSensor.IT_REPORT_PATH_KEY)
      ...
      .index(2)
      .build());
      data.add(PropertyDefinition.builder(CxxCoverageSensor.OVERALL_REPORT_PATH_KEY)
      ...
      .index(3)
      .build());
      data.add(PropertyDefinition.builder(CxxCoverageSensor.FORCE_ZERO_COVERAGE_KEY)
      ...
      .index(4)
      .build());
      data.add(PropertyDefinition.builder(CxxXunitSensor.REPORT_PATH_KEY)
      ...
      .index(5)
      .build());
      data.add(PropertyDefinition.builder(CxxXunitSensor.XSLT_URL_KEY)
      ...
      .index(6)
      .build());
      data.add(PropertyDefinition.builder(CxxXunitSensor.PROVIDE_DETAILS_KEY)
      ...
      .index(7)
      .build());
      data.add(PropertyDefinition.builder(CxxUnitTestResultsProvider.VISUAL_STUDIO_TEST_RESULTS_PROPERTY_KEY)
      ...
      .index(8)
      .build());
      data.add(PropertyDefinition.builder(CxxUnitTestResultsProvider.NUNIT_TEST_RESULTS_PROPERTY_KEY)
